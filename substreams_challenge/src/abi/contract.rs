...
pub mod functions {
    ...
    pub struct ApePrice {}
    impl ApePrice {
        const METHOD_ID: [u8; 4] = [122u8, 63u8, 69u8, 30u8];
        pub fn decode(
    ...
    impl substreams_ethereum::Function for ApePrice {
        const NAME: &'static str = "apePrice";
    ...
    impl BaycProvenance {
        const METHOD_ID: [u8; 4] = [96u8, 126u8, 32u8, 227u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for BaycProvenance {
        const NAME: &'static str = "BAYC_PROVENANCE";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for BaycProvenance {
        fn output(data: &[u8]) -> Result<String, String> {
            Self::output(data)
        }
    }
    ...
    impl EmergencySetStartingIndexBlock {
        const METHOD_ID: [u8; 4] = [125u8, 23u8, 252u8, 190u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for EmergencySetStartingIndexBlock {
        const NAME: &'static str = "emergencySetStartingIndexBlock";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct FlipSaleState {}
    impl FlipSaleState {
        const METHOD_ID: [u8; 4] = [52u8, 145u8, 141u8, 253u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for FlipSaleState {
        const NAME: &'static str = "flipSaleState";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct MaxApePurchase {}
    impl MaxApePurchase {
        const METHOD_ID: [u8; 4] = [87u8, 29u8, 255u8, 59u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for MaxApePurchase {
        const NAME: &'static str = "maxApePurchase";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    pub struct MaxApes {}
    impl MaxApes {
        const METHOD_ID: [u8; 4] = [187u8, 138u8, 22u8, 189u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for MaxApes {
        const NAME: &'static str = "MAX_APES";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxApes {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct MintApe {
        pub number_of_tokens: substreams::scalar::BigInt,
    }
    impl MintApe {
        const METHOD_ID: [u8; 4] = [167u8, 35u8, 83u8, 62u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.number_of_tokens.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for MintApe {
        const NAME: &'static str = "mintApe";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ReserveApes {}
    impl ReserveApes {
        const METHOD_ID: [u8; 4] = [176u8, 246u8, 116u8, 39u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for ReserveApes {
        const NAME: &'static str = "reserveApes";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl RevealTimestamp {
        const METHOD_ID: [u8; 4] = [24u8, 226u8, 10u8, 56u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for RevealTimestamp {
        const NAME: &'static str = "REVEAL_TIMESTAMP";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SaleIsActive {}
    impl SaleIsActive {
        const METHOD_ID: [u8; 4] = [235u8, 141u8, 36u8, 68u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for SaleIsActive {
        const NAME: &'static str = "saleIsActive";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for SaleIsActive {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetProvenanceHash {
        pub provenance_hash: String,
    }
    impl SetProvenanceHash {
        const METHOD_ID: [u8; 4] = [16u8, 150u8, 149u8, 35u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[ethabi::Token::String(self.provenance_hash.clone())],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::Function for SetProvenanceHash {
        const NAME: &'static str = "setProvenanceHash";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetRevealTimestamp {
        pub reveal_time_stamp: substreams::scalar::BigInt,
    }
    impl SetRevealTimestamp {
        const METHOD_ID: [u8; 4] = [1u8, 138u8, 44u8, 55u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.reveal_time_stamp.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for SetRevealTimestamp {
        const NAME: &'static str = "setRevealTimestamp";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetStartingIndex {}
    impl SetStartingIndex {
        const METHOD_ID: [u8; 4] = [233u8, 134u8, 101u8, 80u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for SetStartingIndex {
        const NAME: &'static str = "setStartingIndex";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl StartingIndex {
        const METHOD_ID: [u8; 4] = [203u8, 119u8, 77u8, 71u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for StartingIndex {
        const NAME: &'static str = "startingIndex";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct StartingIndexBlock {}
    impl StartingIndexBlock {
        const METHOD_ID: [u8; 4] = [227u8, 109u8, 100u8, 152u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for StartingIndexBlock {
        const NAME: &'static str = "startingIndexBlock";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
